...
public class AllCameraIOSArchiveMonitoring extends CoreTestCase {
    ...
    private String dateOfTestRun = new SimpleDateFormat("dd MMMM").format(new Date());
    ...
    public void testAuth() throws IOException {
        ...
        if (CamDrivePageObject.authorizationOnCamdrive()){
            ms.sendMSG("WEB IOS: "+dateOfTestRun+" INFO: Авторизация с валидными данными - выполнена.");
        }else {
            ms.sendMSG("WEB IOS: "+dateOfTestRun+" WARNING: Авторизация с валидными данными - не выполнена.");
        }
    }
