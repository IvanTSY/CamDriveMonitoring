...
public class MWCamDrive extends CamDrivePageObject {
    static {
        ...
        DAY_TODAY = "id:2019/06/26";//"xpath://*[contains(@class,'day today')]"; //текущий день
...
//========================================================
        CD100_E770_TEST ="xpath://*[contains(@class,'x-list-item-body')][contains(text(),'cd310_ms4_2F21_')]";
//========================================================
