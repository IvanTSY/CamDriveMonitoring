...
public class MWCamDrive extends CamDrivePageObject {
    static {
        ...
        BACK_BTN_ON_MINUTE_SCREEN = "xpath://div[contains(@id,'ext-comp-1071')][contains(@class,'x-button white-back x-button-back')]/span[contains(text(),'Назад')]";//span[contains(@class,'x-button-label')][contains(@id,'ext-gen1040')]";
